...
| DASHQ-013 | P2 | 2026-08-10 to 2026-08-17 | `complete_on_master` | DASHQ-007 | Improve aggregate-first navigation on dense pages | Reopened by user request on 2026-08-11. Dense pages now place hierarchy levels on separate navigation rows: orange major sections, green level-2 aggregate parents, blue deeper aggregate parents, and purple leaf flows. Intermediate pills target the non-overlapping parent summary charts introduced in `810d3b1`; suppression, manifests, and dataset filtering are unchanged. |
