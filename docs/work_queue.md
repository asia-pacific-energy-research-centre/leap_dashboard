...
| DASHQ-070 | P0 | 2026-08-31 | `in_progress` | AUS-CONSIST-015; corrected AUS fixture | Resolve remaining detailed Services and Transport non-road boundary allocations | The fresh source fixes whole Buildings and bunkers but leaves no LEAP Datacentres child, shifts Services from 305.755577 PJ in 2022 to 523.203917 PJ in 2023, and leaves 2022 non-road at 185.311632 PJ versus ESTO Extended 216.679815 PJ. The upstream fixture task has been asked to correct these allocations or provide evidence that they are intentional before release. |
