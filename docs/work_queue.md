...
| DASHQ-042 | P1 | 2026-08-31 | `in_progress` | DASHQ-041, upstream AUS fixture owner | Remove redundant combined bunker presentation and audit detailed non-road/Power inputs | Detailed Supply now keeps separate marine and aviation product cards plus one combined 04-05 product total; its redundant combined by-flow card is suppressed only when both child cards exist, while placeholder fallback is preserved. The regenerated detailed AUS candidate has 521 charts and browser QA confirms one combined card. Transport non-road and retained Electricity/CHP interim branches are being audited in the source fixture before any further renderer change. |
