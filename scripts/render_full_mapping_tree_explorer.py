...
<div class="box"><label>Source tree <select id="choose"></select></label><label>Mapping labels <select id="mapping-labels"><option value="off">Off</option><option value="esto">Original ESTO components</option><option value="common">Common ESTO targets</option></select></label><label>Year <select id="year"></select></label><label>Scenario <select id="scenario"></select></label><label>Magnitude <select id="magnitude"><option value="1">PJ</option><option value="1000">Thousands of PJ</option><option value="1000000">Millions of PJ</option></select></label><label>Find node <input id="find" placeholder="code or label"></label><span id="count" class="muted"></span></div>
