...
<div class="box"><label>Source tree <select id="choose"></select></label><label>Comparison basis <select id="comparison-basis"><option value="ESTO">ESTO</option>{'<option value="ESTO_EXTENDED" selected>ESTO Extended</option>' if extended_available and prefer_extended_esto else '<option value="ESTO_EXTENDED">ESTO Extended</option>' if extended_available else ''}</select></label><label>Mapping labels <select id="mapping-labels"><option value="off">Off</option><option value="esto">Original ESTO components</option><option value="common">Common ESTO targets</option></select></label><label>Year <select id="year"></select></label><label>Scenario <select id="scenario"></select></label><label>Magnitude <select id="magnitude"><option value="1">PJ</option><option value="1000">Thousands of PJ</option><option value="1000000">Millions of PJ</option></select></label><label>Find node <input id="find" placeholder="code or label"></label><span id="count" class="muted"></span></div>
...
<script>const T={tree_json},R={route_json},N={numeric_json},L=document.querySelector('#left'),Z=document.querySelector('#right'),C=document.querySelector('#common'),S=document.querySelector('#choose'),M=document.querySelector('#mapping-labels'),Y=document.querySelector('#year'),V=document.querySelector('#scenario'),G=document.querySelector('#magnitude'),Q=document.querySelector('#find'),sys={{leap:'LEAP',ninth:'NINTH',esto:'ESTO',esto_extended:'ESTO_EXTENDED'}};let active=[],lastNode=null,labels={{}};
